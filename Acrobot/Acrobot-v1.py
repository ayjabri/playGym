...
params = SimpleNamespace(**{'env_name':'Acrobot-v1',
                            'replay_size':10000,
                            'init_size': 64,
                            'eps_start': 1.0,
                            'eps_final': 0.02,
...
if __name__=='__main__':
    ...
    parser.add_argument('-envs', default=1, type=int, help='Number of Environments to draw samples from')
    ...
    while True:
        ...
        if done_reward:
            ...
            if mean_rewards > params.solve_reward:
                ...
                tgt_net.sync()
                torch.save(tgt_net.target_model.state_dict(),f'Acrobot-v1_{args.noisy}_{args.n}.dat')
