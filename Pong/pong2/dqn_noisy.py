...
if __name__ == "__main__":
    ...
    writer = SummaryWriter(comment="-" + params['run_name'] + "-4n-noisy-net")
    ...
    exp_source = ptan.experience.ExperienceSourceFirstLast(env, agent, gamma=params['gamma'], steps_count=4) # I changed step counts to 4
    ...
    with common.RewardTracker(writer, params['stop_reward']) as reward_tracker:
        while True:
            ...
            loss_v = common.calc_loss_dqn(batch, net, tgt_net.target_model, gamma=params['gamma']**4, device=device) # I changed to gamma^4
            loss_v.backward()
            optimizer.step()
